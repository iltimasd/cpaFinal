...
void initTextmode() {
  ...
  b = createGraphics(width/segSize, height/segSize, P2D);  // we need P3D for our shapes
...
void renderTextMode() {
  ...
  {                                       // because 192 / 4 = 48.
    ...
    {                                     // because 256 / 4 = 64.
      ...
      float segb = (allBri / (segSize * segSize) ); 
      
      tableStore[h][w]=map(segb,0,255,-1,1);
      
      // just like above, we get the average brightness
